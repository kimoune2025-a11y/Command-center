...
# Create the main app
app = FastAPI(title="CVLN Command Center API")
...
class FinanceCreate(BaseModel):
    type: str  # expense, revenue, budget
    category: str
    amount: float
    description: Optional[str] = ""
    project_id: Optional[str] = None
...
class ContactCreate(BaseModel):
    ...
    type: str = "partner"  # partner, sponsor, artist, institution, investor
    notes: Optional[str] = ""
...
class KPICreate(BaseModel):
    ...
    value: float
    unit: str = ""
    category: str = "general"  # revenue, growth, performance, engagement
